"""
Django settings for media_converter project.
...
SECRET_KEY = 'django-insecure-hh)k4l8+ue883*yp$69@768ylqg)s+pocq&x-qn$t6qcjqzzw@'
...
MEDIA_URL = '/media/'           #definesc URL-ul
MEDIA_ROOT = BASE_DIR / 'media' #și folderul unde Django stochează și servește fișierele media (upload-uri).
